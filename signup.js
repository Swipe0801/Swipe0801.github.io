...
function signup() {
    ...
    if (!localStorage) {
        ...
        localStorage["email" + numUsers] = document.getElementById("email").value;
        localStorage["birth" + numUsers] = document.getElementById("birthdate").value;
        localStorage["age" + numUsers] = document.getElementById("age").value;
        localStorage["interest" + numUsers] = document.getElementById("interest").value;
